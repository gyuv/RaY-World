...
/**
 * Interactive shell for a horizontal poster rail: the scroll container plus the
 * left/right arrow buttons. This is the ONLY client part of a rail — the cards
 * themselves are passed in as `children` from the server <MediaRail>, so they
 * render as Server Components and never ship to / hydrate on the client. That
 * keeps the many rails on a page cheap: only the small scroll logic hydrates,
 * not every poster.
 */
export function MediaRailClient({
  title,
  accent,
  href,
  priority,
